# Black_Jack
Упрощенный вариант карточной игры Black_Jack
...
Также 2 случайные карты выдаются «дилеру», против которого играет пользователь. Пользователь не видит карты дилера.
